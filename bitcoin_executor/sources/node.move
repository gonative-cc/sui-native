...
use bitcoin_executor::block::{Self, Block};
...
public fun execute_block(state: &mut State, block: &Block) {
...
fun execution_node_test() {
    ...
    let (outpint, info) = utxo::new(x"d2515c87b7afba3a576e80af3727b7511025a9615db33a3a768415601aeb59c1", 0, 0, true, 5000000000, x"001460bef4984dfcc473d6459368f4f1f9a21d1f4d74");
