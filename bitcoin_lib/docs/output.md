...
<dl>
<dt>
<code><a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount">amount</a>: u64</code>
</dt>
<dd>
</dd>
<dt>
<code><a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount_bytes">amount_bytes</a>: vector&lt;u8&gt;</code>
</dt>
<dd>
</dd>
<dt>
<code><a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>: vector&lt;u8&gt;</code>
</dt>
<dd>
</dd>
</dl>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_new">new</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount">amount</a>: u64, <a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>: vector&lt;u8&gt;): <a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a> {
    <a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a> {
        <a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount">amount</a>,
        <a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount_bytes">amount_bytes</a>: u64_to_le_bytes(<a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount">amount</a>),
        <a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>,
    }
}
</code></pre>
...
<a name="bitcoin_lib_output_amount"></a>
...
<a name="bitcoin_lib_output_script_pubkey"></a>
...
<a name="bitcoin_lib_output_is_P2SH"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_P2SH">is_P2SH</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): bool {
    ...
    script.length() == 23 &&
	script[0] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_HASH160">OP_HASH160</a> &&
	script[1] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_DATA_20">OP_DATA_20</a> &&
	script[22] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_EQUAL">OP_EQUAL</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_P2WSH">is_P2WSH</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): bool {
    <b>let</b> script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>();
    script.length() == 34 &&
	script[0] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_0">OP_0</a> &&
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_P2PHK">is_P2PHK</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): bool {
    <b>let</b> script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>();
    script.length() == 25 &&
		script[0] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_DUP">OP_DUP</a> &&
		script[1] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_HASH160">OP_HASH160</a> &&
		script[2] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_DATA_20">OP_DATA_20</a> &&
		script[23] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_EQUALVERIFY">OP_EQUALVERIFY</a> &&
		script[24] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_CHECKSIG">OP_CHECKSIG</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_op_return">is_op_return</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): bool {
    <b>let</b> script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>;
    script.length() &gt; 0 && script[0] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_RETURN">OP_RETURN</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_taproot">is_taproot</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): bool {
    <b>let</b> script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>;
    script.length() == 34 &&
	script[0] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_1">OP_1</a> &&
	script[1] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_DATA_32">OP_DATA_32</a>
}
</code></pre>
...
<a name="bitcoin_lib_output_extract_public_key_hash"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_extract_public_key_hash">extract_public_key_hash</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): Option&lt;vector&lt;u8&gt;&gt; {
    <b>let</b> script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>;
    <b>if</b> (<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_P2PHK">is_P2PHK</a>()) {
        <b>return</b> option::some(vector_slice(&script, 3, 23))
    } <b>else</b> <b>if</b> (<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_P2WPHK">is_P2WPHK</a>()) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_extract_script_hash">extract_script_hash</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): Option&lt;vector&lt;u8&gt;&gt; {
    <b>let</b> script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>;
    <b>if</b> (<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_P2SH">is_P2SH</a>()) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_extract_witness_script_hash">extract_witness_script_hash</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): Option&lt;vector&lt;u8&gt;&gt; {
    <b>let</b> script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>;
    <b>if</b> (<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_P2WSH">is_P2WSH</a>()) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_extract_taproot">extract_taproot</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): Option&lt;vector&lt;u8&gt;&gt; {
    <b>let</b> script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>;
    <b>if</b> (<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_is_taproot">is_taproot</a>()) {
        option::some(vector_slice(&script, 2, 34))
    } <b>else</b> {
        option::none()
    }
...
<pre><code><b>public</b> <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_op_return">op_return</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): Option&lt;vector&lt;u8&gt;&gt; {
    ...
    <b>if</b> (script[1] &lt;= <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_DATA_75">OP_DATA_75</a>) {
        // script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_RETURN">OP_RETURN</a> OP_DATA_&lt;len&gt; DATA
        //          |      2 bytes         |  the rest |
        <b>return</b> option::some(vector_slice(&script, 2, script.length()))
    };
    <b>if</b> (script[1] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_PUSHDATA1">OP_PUSHDATA1</a>) {
        // script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_RETURN">OP_RETURN</a> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_PUSHDATA1">OP_PUSHDATA1</a> &lt;1 bytes&gt;    DATA
        //          |      3 bytes                  |  the rest |
        <b>return</b> option::some(vector_slice(&script, 3, script.length()))
    };
    <b>if</b> (script[1] == <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_PUSHDATA2">OP_PUSHDATA2</a>) {
        // script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_RETURN">OP_RETURN</a> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_PUSHDATA2">OP_PUSHDATA2</a> &lt;2 bytes&gt;   DATA
        //          |      4 bytes                  |  the rest |
        <b>return</b> option::some(vector_slice(&script, 4, script.length()))
    };
    // script = <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_RETURN">OP_RETURN</a> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_OP_PUSHDATA4">OP_PUSHDATA4</a> &lt;4-bytes&gt; DATA
    //          |      6 bytes                  |  the rest |
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_decode">decode</a>(r: &<b>mut</b> Reader): <a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a> {
    ...
    <b>let</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a> = r.read(script_pubkey_size);
    <a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a> {
        <a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount">amount</a>: le_bytes_to_u64(<a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount_bytes">amount_bytes</a>),
        <a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount_bytes">amount_bytes</a>,
        <a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>,
    }
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bitcoin_lib/output.md#bitcoin_lib_output_encode">encode</a>(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>: &<a href="../bitcoin_lib/output.md#bitcoin_lib_output_Output">Output</a>): vector&lt;u8&gt; {
    ...
    raw_output.append(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_amount_bytes">amount_bytes</a>);
    raw_output.append(u64_to_varint_bytes(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>.length()));
    raw_output.append(<a href="../bitcoin_lib/output.md#bitcoin_lib_output">output</a>.<a href="../bitcoin_lib/output.md#bitcoin_lib_output_script_pubkey">script_pubkey</a>);
    raw_output
}
</code></pre>
