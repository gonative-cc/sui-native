...
fun pkh_script_happy_cases() {
    ...
    assert_eq!(output.extract_public_key_hash(), option::some(x"55ae51684c43435da751ac8d2173b2652eb64105"));
    ...
    assert_eq!(output.extract_public_key_hash(), option::some(x"841b80d2cc75f5345c482af96294d04fdd66b2b7"));
