...
fun der_sig_test() {
    ...
    assert_eq!(
        redeem_request::der_encode_signature(signature, 0x01),
        x"3045022056a5f8f208642739120338e01bef72658f9db450e29dace5e9f5cb51542c62880222008822b4bbb45e04c421769abc2195624d7c2e0918d1b33a9adcf29eb4762178243401",
    );
}
