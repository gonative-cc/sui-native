...
export async function sign_message(
  ...
  const verifiedPartialSignature =
    await ikaClient.getPartialUserSignatureInParticularState(
...
export async function completeFetureRequest(
  dWallet: DWalletWithState<"Active">,
  message: Uint8Array,
...
export async function request_signature_for_input(
  ...
  let verifiedCap = tx.moveCall({
    target:
      "0x6573a6c13daf26a64eb8a37d3c7a4391b353031e223072ca45b1ff9366f59293::coordinator::verify_partial_user_signature_cap",
    arguments: [
      tx.object(
